...
:white_check_mark: протестировано, работает отлично: `PostgreSQL 11, 14`

[**Postgres Pro**](https://www.postgrespro.ru) - Российская система управления базами данных на основе PostgreSQL. Репозиторий - используется внешний источник, платный продукт.
Поддерживаются все поддерживаемые версии Postgres Pro, поддерживаются редакции Standard и Enterprise.

:white_check_mark: протестировано, работает отлично: `Postgres Pro 14`

##### Операционные Системы:
- **Debian**: 9, 10, 11
- **Astra Linux**: CE (основан на Debian 9), SE (основан на Debian 10)
:white_check_mark: протестировано, работает отлично: `Astra Linux CE 2.12, Astra Linux SE 1.7`
