...
- [Making an issue](https://help.github.com/articles/creating-an-issue/). A well described issue helps a lot. (Have a look at the [known issues](https://github.com/search?q=user%3Avitabaks+is%3Aissue+state%3Aopen).)
...
Here is how you can help, a lot of steps are related to GitHub, not specifically this project.
...
Run `make reinitialization` or `make bootstrap` for initializing the virutalenv and installing all deps.

The, run test with `make molecule-test` or `make molecule-converge` for only the converge sequence.
...
Once it start to work, you can push your code
