...
INSERT INTO public.cloud_images (cloud_provider, region, image, arch, os_name, os_version, updated_at) VALUES
    ...
    ('aws', 'ap-south-1', '{"server_image": "ami-0d82b4dd52aa37cc3"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'ap-south-2', '{"server_image": "ami-0abf88d7671119127"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'ap-southeast-3', '{"server_image": "ami-0fb840c267c9798a4"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'ap-southeast-4', '{"server_image": "ami-0de41b55a37aa24b6"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'ap-northeast-1', '{"server_image": "ami-047b270f7afae25a9"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'ap-northeast-2', '{"server_image": "ami-00dade17b7cbec931"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'ap-northeast-3', '{"server_image": "ami-06d946d6e0d7e0a3b"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'ap-southeast-1', '{"server_image": "ami-0b1d56f717447bdcf"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'ap-southeast-2', '{"server_image": "ami-015c2e3917f29eec9"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'eu-central-1', '{"server_image": "ami-0c027353d00750a02"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'eu-central-2', '{"server_image": "ami-0e058ee110e570f72"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'eu-west-1', '{"server_image": "ami-003c6328b40ce2af6"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'eu-west-2', '{"server_image": "ami-0d05d6fe284781e13"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'eu-west-3', '{"server_image": "ami-061fc0c4ca50c3135"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'eu-north-1', '{"server_image": "ami-0c0a1c5b612d238ae"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'eu-south-1', '{"server_image": "ami-02b44d454d6fdf306"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'eu-south-2', '{"server_image": "ami-0d4fc4ae17783f6bc"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'me-south-1', '{"server_image": "ami-01a4b9ac29969a669"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'me-central-1', '{"server_image": "ami-0934b7ea698655531"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'us-east-1', '{"server_image": "ami-012485deee5681dc0"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'us-east-2', '{"server_image": "ami-0df0b6b7f8f5ea0d0"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'us-west-1', '{"server_image": "ami-0344e2943d3053eda"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'us-west-2', '{"server_image": "ami-0526a31610d9ba25a"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'ca-central-1', '{"server_image": "ami-0bb0ed6088d3b1bec"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'ca-west-1', '{"server_image": "ami-084542ffdec042eef"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('aws', 'sa-east-1', '{"server_image": "ami-08df96b48d7147886"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('gcp', 'all', '{"server_image": "projects/ubuntu-os-cloud/global/images/family/ubuntu-2204-lts"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('azure', 'all', '{"azure_vm_image_offer": "0001-com-ubuntu-server-jammy", "azure_vm_image_publisher": "Canonical", "azure_vm_image_sku": "22_04-lts-gen2", "azure_vm_image_version": "latest"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('digitalocean', 'all', '{"server_image": "ubuntu-22-04-x64"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15'),
    ('hetzner', 'all', '{"server_image": "ubuntu-22.04"}', 'amd64', 'Ubuntu', '22.04 LTS', '2024-05-15');
